...
public class IncreasedMaintenance extends BaseHullMod {
	...
	private static final float MAINTENANCE_PERCENT = 50;
	...
	public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
		...
		stats.getMinCrewMod().modifyPercent(id, MAINTENANCE_PERCENT * effect);
	...
	public String getDescriptionParam(int index, HullSize hullSize, ShipAPI ship) {
		...
		if (index == 1) return "" + (int)Math.round(MAINTENANCE_PERCENT * effect) + "%";
