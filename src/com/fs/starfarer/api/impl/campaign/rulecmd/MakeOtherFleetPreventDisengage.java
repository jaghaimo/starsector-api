 ...
 */
public class MakeOtherFleetPreventDisengage extends BaseCommandPlugin {
	...
	public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Token> params, Map<String, MemoryAPI> memoryMap) {
		...
		Misc.setFlagWithReason(memory, MemFlags.MEMORY_KEY_MAKE_PREVENT_DISENGAGE, reason, value, expire);
