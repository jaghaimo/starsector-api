...
public class MakeOtherFleetNonAggressive extends BaseCommandPlugin {
	...
	public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Token> params, Map<String, MemoryAPI> memoryMap) {
		...
		Misc.setFlagWithReason(memory, MemFlags.MEMORY_KEY_MAKE_NON_AGGRESSIVE, reason, value, expire);
