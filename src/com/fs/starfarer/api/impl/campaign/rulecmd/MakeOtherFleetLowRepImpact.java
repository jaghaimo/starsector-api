 ...
 * @author Alex Mosolov
 *
 *	MakeOtherFleetLowRepImpact <reason> <true or false>
 *
 * Copyright 2015 Fractal Softworks, LLC
 */
public class MakeOtherFleetLowRepImpact extends BaseCommandPlugin {
...
//		}
		...
		boolean stillSet = Misc.setFlagWithReason(memory, MemFlags.MEMORY_KEY_LOW_REP_IMPACT, reason, value, expire);
