...
public class HTScanFactor extends BaseOneTimeFactor {
	
	protected String desc;

	public HTScanFactor(String desc, int points) {
		super(points);
		this.desc = desc;
	}
	...
	public TooltipCreator getMainRowTooltip() {
		return new BaseFactorTooltip() {
			...
			public void createTooltip(TooltipMakerAPI tooltip, boolean expanded, Object tooltipParam) {
				tooltip.addPara("An %s of the right entity or location can provide insight into the "
						...
						0f, Misc.getHighlightColor(), "Active Sensor Burst");
			}
