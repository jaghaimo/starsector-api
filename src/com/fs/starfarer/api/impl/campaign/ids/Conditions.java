...
public class Conditions {
	...
	//public static final String SHIPBREAKING_CENTER = "shipbreaking_center";
	//public static final String TRADE_CENTER = "trade_center";
	...
	//public static final String COTTAGE_INDUSTRY = "cottage_industry";
	...
	//public static final String UNINHABITABLE = "uninhabitable";
	...
	//public static final String ORBITAL_STATION = "orbital_station";
	...
	//public static final String EVENT_SYSTEM_BOUNTY = "event_bounty";
	public static final String EVENT_FOOD_SHORTAGE = "event_food_shortage";
	
	
//	public static final String EVENT_TRADE_DISRUPTION = "event_trade_disruption";
//	public static final String EVENT_SMUGGLING = "event_smuggling";
