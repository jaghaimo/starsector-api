...
public class SynchrotronItemPlugin extends BaseSpecialItemPlugin {
	...
	public void createTooltip(TooltipMakerAPI tooltip, boolean expanded, CargoTransferHandlerAPI transferHandler, Object stackSource) {
		...
		SynchrotronEffect effect = SynchrotronInstallableItemPlugin.SYNCHROTRON_EFFECTS.get(getId());
		if (effect != null) {
